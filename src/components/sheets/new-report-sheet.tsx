...
export function NewReportSheet({
  ...
  const { activeProjectId, refreshReports } = useShell();
    ...
    >
      <label className="mb-4 block">
        ...
        <input
          ...
          placeholder="Spring music — monthly partner roundup"
          disabled={disabled}
      ...
      <label className="mb-4 block">
        ...
        <textarea
          ...
          rows={3}
          placeholder="What the report covers — used as the email subject and intro."
          disabled={disabled}
      ...
      <p className="t-small text-ink-3">
        Reports scope the whole project. Recipients, account picks and
        password protection land in a later round.
      </p>
